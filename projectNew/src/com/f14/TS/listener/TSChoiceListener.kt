 ...
 * @author F14eagle
 */
class TSChoiceListener(trigPlayer: TSPlayer, gameMode: TSGameMode, initParam: ChoiceInitParam) : TSParamInterruptListener(trigPlayer, gameMode, initParam) {
    ...
    private fun sendChoiceParamInfo(p: TSPlayer) {
        ...
        val card = this.card!!
        res.public("choice1", card.abilityGroup!!.descr1)
        res.public("choice2", card.abilityGroup!!.descr2)
