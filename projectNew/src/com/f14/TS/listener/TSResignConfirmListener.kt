 ...
 * @author F14eagle
 */
class TSResignConfirmListener(trigPlayer: TSPlayer, gameMode: TSGameMode, initParam: ChoiceInitParam) : TSParamInterruptListener(trigPlayer, gameMode, initParam) {
    ...
    private fun sendChoiceParamInfo(p: TSPlayer) {
        ...
        res.public("choice1", "我确定要投降")
        res.public("choice2", "感觉还能继续")
