 ...
 * @author F14eagle
 */
class InnoCustom027P2Listener(gameMode: InnoGameMode, trigPlayer: InnoPlayer, initParam: InnoInitParam?, resultParam: InnoResultParam, ability: InnoAbility?, abilityGroup: InnoAbilityGroup?) : InnoChooseSpecificCardListener(gameMode, trigPlayer, initParam, resultParam, ability, abilityGroup) {
    ...
    override fun processChooseCard(player: InnoPlayer, card: InnoCard) {
        ...
        gameMode.game.playerAddScoreCard(this.currentPlayer, resultParam)
    }
